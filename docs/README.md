...
| [mcp-compliance.md](mcp-compliance.md) | **Generated** — the current MCP protocol conformance score against every vendored spec revision, with per-dimension detail, method/capability coverage, and findings. Regenerated by `spec-check`; do not edit by hand. |
