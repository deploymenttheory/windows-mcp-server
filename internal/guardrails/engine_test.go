...
func newTestEngine(t *testing.T, policyJSON string, outcomes map[string]Status) (*Engine, *countingRegistry) {
	t.Helper()
	...
	return NewEngine(p, cr.reg, testIndex, func() *Env { return &Env{} }), cr
}
...
func TestRuleMatchingScalesWithWhatTheCallCanDo(t *testing.T) {
	e, _ := newTestEngine(t, layeredPolicy, map[string]Status{
		"run-context": Pass, "bitlocker": Fail, "mdm-enrolled": Pass,
	})
...
func TestSeverityIsAttributedToTheMostSpecificRule(t *testing.T) {
	e, _ := newTestEngine(t, layeredPolicy, map[string]Status{
		"run-context": Pass, "bitlocker": Pass, "mdm-enrolled": Fail,
	})
...
func TestRequirementsUnionAcrossMatchingRules(t *testing.T) {
	e, _ := newTestEngine(t, layeredPolicy, map[string]Status{
		"run-context": Fail, "bitlocker": Fail, "mdm-enrolled": Fail,
	})
	v := e.Evaluate(context.Background(), e.SubjectForTool("tools/call", "PowerShell"))
...
func TestAuditModeClampsButStillRecords(t *testing.T) {
	...
	e, cr := newTestEngine(t, auditPolicy, map[string]Status{"bitlocker": Fail})
	v := e.Evaluate(context.Background(), e.SubjectForTool("tools/call", "PowerShell"))
...
func TestPassingSignalsProduceNoFailures(t *testing.T) {
	e, _ := newTestEngine(t, layeredPolicy, map[string]Status{
		"run-context": Pass, "bitlocker": Pass, "mdm-enrolled": Pass,
	})
	v := e.Evaluate(context.Background(), e.SubjectForTool("tools/call", "PowerShell"))
...
// TestSkippedSignalIsNotAFailure: Skip means "not applicable here", which is how
...
func TestSkippedSignalIsNotAFailure(t *testing.T) {
	e, _ := newTestEngine(t, layeredPolicy, map[string]Status{
		"run-context": Pass, "bitlocker": Skip, "mdm-enrolled": Pass,
	})
...
func TestErrorIsAFailure(t *testing.T) {
	e, _ := newTestEngine(t, layeredPolicy, map[string]Status{
		"run-context": Error, "bitlocker": Pass, "mdm-enrolled": Pass,
	})
...
func TestUnknownToolStillMatchesTheBaseline(t *testing.T) {
	e, _ := newTestEngine(t, layeredPolicy, map[string]Status{
		"run-context": Fail, "bitlocker": Pass, "mdm-enrolled": Pass,
	})
...
func TestStartupScopeIsSeparateFromCallScope(t *testing.T) {
	...
	e, _ := newTestEngine(t, policy, map[string]Status{"run-context": Fail, "bitlocker": Pass})
	ctx := context.Background()
...
func TestSelectorsWithinOneMatchAreAnded(t *testing.T) {
	...
	e, _ := newTestEngine(t, policy, map[string]Status{"bitlocker": Fail})
	ctx := context.Background()
	...
	// Registry is destructive but in a different toolset; Snapshot is in neither.
...
func TestRateLimitShareOneWindowPerLimit(t *testing.T) {
	...
	e, _ := newTestEngine(t, policy, map[string]Status{})
	ctx := context.Background()
...
func TestExplainReportsCoverageWithoutEvaluating(t *testing.T) {
	e, cr := newTestEngine(t, layeredPolicy, map[string]Status{
		"run-context": Pass, "bitlocker": Pass, "mdm-enrolled": Pass,
	})
